...
DEFAULT_PRESENCE = MODEL_ROOT / "artifacts" / "constrained_temporal_presence.joblib"
DEFAULT_CLASS = MODEL_ROOT / "artifacts" / "classification_ensemble.joblib"
DEFAULT_OUTPUT = MODEL_ROOT / "training" / "temporal_state_stacker"
            ...
            for start_threshold in thresholds:
                ...
                for end_threshold in thresholds:
                    ...
                    key = (
                        ...
                        float(np.mean((truth_start == pred_start) & (truth_end == pred_end))),
                    )
...
def main() -> None:
    ...
    result = {
        ...
        "selection_metric": "grouped validation out-of-fold classification accuracy, then macro F1",
        "selection": config,
